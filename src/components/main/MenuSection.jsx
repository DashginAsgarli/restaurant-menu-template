            ...
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mb-20 md:mb-32">
                    {[
                        ...
                        <div key={i} className={`relative group rounded-[24px] md:rounded-[30px] overflow-hidden bg-black aspect-[4/5] ${card.offset} shadow-xl md:shadow-2xl`}>
                            ...
                            <div className="absolute inset-4 border border-white/20 rounded-[20px] md:rounded-[24px] pointer-events-none group-hover:border-[#fdb714]/50 transition duration-500"></div>
